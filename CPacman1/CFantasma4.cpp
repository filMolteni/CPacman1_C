...
void CFantasma4::setR(int r)
{
    this->cordinata.setR(r);
}

void CFantasma4::setC(int c)
{
    this->cordinata.setC(c);
}
void CFantasma4::muovi(char alto, char sotto, char sinistra, char destra)
{
